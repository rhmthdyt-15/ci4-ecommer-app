                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <div class="col-sm-8">
                            <div class="custom-file">
                                <?php if (isset($input->image) && $input->image && file_exists(FCPATH . 'images/product/' . $input->image)) : ?>
                                <img src="<?= base_url('images/product/' . $input->image) ?>" alt="" height="100"
                                    class="img-preview">
                                <?php else : ?>
                                <img src="<?= base_url('images/product/default.png') ?>" alt="Placeholder Image"
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check form-check-inline">
                            <?= form_radio('is_available', '1', (isset($input->is_available) && $input->is_available == 1) ? true : false, ['class' => 'form-check-input']) ?>
                            <label for="is_available" class="form-check-label">Tersedia</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <?= form_radio('is_available', '0', (isset($input->is_available) && $input->is_available == 0) ? true : false, ['class' => 'form-check-input']) ?>
